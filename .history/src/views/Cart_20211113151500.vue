<template>
  <div class="cart-page">
    <div class="container py-4">
        ...
        <div class="col-12 col-sm-12 col-md-9">
          <div class="cart-contain">
           <!--  <div class="row header-cart justify-content-between text-center">
            ...
            <div class="row header-cart justify-content-between align-items-center mt-4 mb-3">
      ...
      <div class="col-12 col-sm-2">
         <div class="item-categ text-center">C    ategory</div>
      </div>
      <div class="col-12 col-sm-2">
      ...
      <div class="col-12 col-sm-2">
        ...
        <span>Remove</span>
            ...
            <div class="row text-center body-cart justify-content-center">
              <div class="col-12" v-if="!cartObjects.length">
