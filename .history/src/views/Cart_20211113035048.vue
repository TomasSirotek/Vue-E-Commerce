            ...
            <div class="row text-center body-cart justify-content-center">
              <div class="col-12" v-if="!cartObjects.length">
                ...
                <CartItem
                  ...
                  :key="item.id"
                  :item="item"
                  class="col-xxl-1 col-xl-2 col-lg-2 col-md-2 col-12 order-xl-0 order-lg-0 order-md-0 order-1 d-flex align-items-center justify-content-center pocet_holder item-cart"
                />
