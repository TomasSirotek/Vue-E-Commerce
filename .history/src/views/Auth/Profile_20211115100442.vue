        ...
        <div class="col-12 col-md-6">
          ...
          <form class="user">
            ...
            <div class="login-grup login-btn mt-4">
              <b-button type="submit" @click.prevent="updateProfile" class="button2"
                >Update</b-button
              >
              <b-button class="ml-3" @click.prevent="showPsw" class="button2">{{
                btnText
              }}</b-button>
              <router-link to="/admin" v-if="isAdmin">
                <button class="button2" class="ml-3">
...
export default {
  ...
  methods: {
    updateProfile() {
      ...
      this.boxOne = "";
      this.$bvModal
        .msgBoxOk("Your changes were update !", {
          size: "md",
          centered: true,
        })
        .then((value) => {
