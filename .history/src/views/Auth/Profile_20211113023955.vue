      ...
      <div class="row justify-content-center mt-4">
        ...
        <!--    <div class="login-grup login-btn mt-4">
           ...
           <div class="container d-flex-start">
             <div class="row">
               <div class="col"> <b-button type="submit" @click.prevent="updateProfile" id="button"
                >Update</b-button
              >
              
              </div>
               <div class="col"> <b-button   @click.prevent="showPsw" id="button"
                >{{btnText}}</b-button
              >
