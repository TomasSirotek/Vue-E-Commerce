      ...
      <div class="row justify-content-center mt-4">
        <div class="col-12 col-md-6">
          ...
          <div class="container d-flex-start">
            <div class="row">
              ...
              <div class="col">
                <b-button @click.prevent="showPsw" id="button">{{
                  btnText
                }}</b-button>
              </div>
        ...
        <div class="col-12 col-md-6 mt-2">
          ...
          <!--  <div class="role-status mt-5">
           ...
           <div class="row">
             <div class="col-2"><span id="button" v-if="isAdmin">Admin</span></div>
             <div class="col-2"><span id="button" v-else >User</span></div>
           </div>
           <div class="mt-3">
               <router-link to="/admin" v-if="isAdmin">
                <button id="button" >
