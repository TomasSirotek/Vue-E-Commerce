    ...
    <div class="row">
      <div class="col-xxl-2 col-xl-3 col-lg-3 mb-15">
        <div class="row flex-column mt-4">
          <b-button variant="dark" class="buttonSort" @click="sortBy('title')"
            >A-Z</b-button
          >
          <b-button variant="info"  @click="sortBy4('title')" class="mt-3 buttonSort"
            >Z-A</b-button
          >
          <b-button variant="info" @click="sortBy2('price')" class="mt-3 buttonSort"
            >Sort By High To Low</b-button
          >
          <b-button variant="info" @click="sortBy3('price')" class="mt-3 buttonSort"
