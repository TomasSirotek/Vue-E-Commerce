    ...
    <div class="row ">
      <div class="col-xxl-2 col-xl-3 col-lg-3 mb-15">
        <div class="row flex-column mt-4">
          ...
          <b-button variant="info" @click='sortBy4("title")' class="mt-3">Z-A</b-button>
         <b-button variant="info" @click='sortBy2("price")' class="mt-3">Sort By High To High</b-button>
         <b-button variant="info" @click='sortBy3("price")' class="mt-3">Sort By Low To High</b-button>
...
export default {
  ...
  methods:{ 
     ...
     sortBy4(prop){
      this.$store.state.games.sort((a,b) => a[prop] < b[prop] ? -1 : 1).reverse()
    },
