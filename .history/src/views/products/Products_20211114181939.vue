    ...
    <div class="row">
      <div class="col-xxl-2 col-xl-3 col-lg-3 mb-15">
        <div class="row flex-column mt-4">
          <b-button variant="info" class="buttonSort" @click="sortBy('title')"
            >A-Z</b-button
          >
          <b-button variant="info"class="buttonSort" @click="sortBy4('title')" class="mt-3"
            >Z-A</b-button
          >
          <b-button variant="info" class="buttonSort" @click="sortBy2('price')" class="mt-3"
            >Sort By High To Low</b-button
          >
          <b-button variant="info" class="buttonSort" @click="sortBy3('price')" class="mt-3"
            >Sort By Low To High</b-button
          >
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    sortBy3(prop) {
      this.$store.state.games.sort((a, b) => a[prop] - b[prop]);
    },
    sortBy4(prop) {
