<template>
  ...
  <div class="overview mt-4">
    <div class="row justify-content-between mb-3 ">
      ...
      <div class="col  d-flex justify-content-end">{{ cartTotal.toFixed(2) }}$</div>
    </div>
    <div class="row justify-content-between mb-3 pt-3 total-overall">
      <div class="col ">Total price</div>
      <div class="col  total-price d-flex justify-content-end">{{ cartTotal.toFixed(2) }}$</div>
    </div>
  ...
  computed: {
   /*  cart_Total() {
    ...
    orderItems() {
     ...
     ...mapGetters(['cartTotal','orderItems']), 

    
  },
  beforeCreate() {
    store.dispatch("setOrderItems");
  },
