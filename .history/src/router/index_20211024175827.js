...
import CategoryPS5 from '../views/products/CategoryPS5.vue'
import CategoryPS4 from '../views/products/CategoryPS4.vue'
import CategoryXbox from '../views/products/CategoryXbox.vue'
...
const router = new VueRouter({
  ...
  routes:[
    ...
    {
      path: `${routes.productDetails}/:gameid`,
      name: 'productDetails',
